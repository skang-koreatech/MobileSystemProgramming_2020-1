package kr.ac.koreatech.swkang.msp11_stepmonitor;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAccelX = findViewById(R.id.accelX);
        mAccelY = findViewById(R.id.accelY);
        mAccelZ = findViewById(R.id.accelZ);

        stepsText = findViewById(R.id.count);
    }
